...
import "./PostCard.css";
import { Dropdown, Space, Progress, Button } from "antd";
...
function PostCard({ data, isError, isLoading }) {
          ...
          <div className="author-des">
            ...
            <div className="avatar">
              ...
              <div className="author-des-post">
                <p className="author-name">{data[0].user.username}</p>
                <span className="post-createat">
                  {moment(data[0].createDate).format(
          ...
          <div className="post-content">
            ...
            <div>
              ...
              <div className="post-content-body">
                ...
                />
                <div>
                  <p>{data[0].book.title}</p>
                  <p>{data[0].book.author}</p>
                  <Progress
                    style={{ width: "280px" }}
                    percent={100}
                    strokeColor={{
                  ...
                  <div style={{ marginBottom: "30px" }}>
                    <Space>
                      <span>
                        {data[0].book.page}/{data[0].book.page}
                      </span>
